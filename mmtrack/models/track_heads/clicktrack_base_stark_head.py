...
class ClickTrackCornerPredictorHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 feat_size: int = 20,
                 stride: int = 16):
        super(ClickTrackCornerPredictorHead, self).__init__()
...
@MODELS.register_module()
class ClickTrackScoreHead(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_layers: int,
                 use_bn: bool = False):
        super(ClickTrackScoreHead, self).__init__()
...
@MODELS.register_module()
class ClickTrackStarkTransformer(Transformer):
    ...
    def __init__(
        ...
        super(ClickTrackStarkTransformer, self).__init__(
            encoder=encoder, decoder=decoder, init_cfg=init_cfg)

    def forward(self, x: Tensor, mask: Tensor, query_embed: Tensor,
                pos_embed: Tensor, text_feat: Union[Tensor, None]) -> Tuple[Tensor, Tensor]:
        ...
        if text_feat is not None:
            target = rearrange(text_feat, '() b c () () -> () b c')
...
@MODELS.register_module()
class ClickTrackStarkHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 frozen_modules=None,
                 **kwargs):
        super(ClickTrackStarkHead, self).__init__(init_cfg=init_cfg)
    ...
    def forward(self, inputs: List[dict], text_feat: Union[Tensor, None]) -> dict:
        """"
        Args:
    ...
    def predict(self, inputs: List[dict], data_samples: SampleList,
                prev_bbox: Tensor, scale_factor: Tensor, text_feat: Union[Tensor, None]) -> InstanceList:
    ...
    # SOT.
    def loss(self, inputs: List[dict], data_samples: SampleList, text_feat: Union[Tensor, None],
             **kwargs) -> dict:
        """Compute loss.
