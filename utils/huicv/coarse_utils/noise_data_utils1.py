...
from utils.huicv.interactivate.path_utils import makedirs_if_not_exist
from utils.huicv.interactivate.cmd import input_yes
from utils.huicv.json_dataset.coco_ann_utils import dump_coco_annotation
...
if __name__ == '__main__':
    ...
    """
    python huicv/coarse_utils/noise_data_utils.py generate_noisept_dataset data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_train_fixname_fixmiss.json data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_train_fixname_fixmiss_add-points.json --size_range 0.5 --rand_type range_gaussian
    --size_range 0.5
    python huicv/coarse_utils/noise_data_utils.py generate_noisept_dataset data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_train_fixname_fixmiss.json data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_train_fixname_fixmiss_add-points.json --size_range 0.5 --rand_type range_gaussian
    --size_range 0.5 val
    python huicv/coarse_utils/noise_data_utils.py generate_noisept_dataset data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_val.json data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_val_add-points_size-range-0.5.json --size_range 0.5 --rand_type range_gaussian

    --coco 
    --size_range 0.5
    --train
    python huicv/coarse_utils/noise_data_utils.py generate_noisept_dataset data/coco/coco/annotations/instances_train2017.json data/coco/coco/annotations/instances_train2017_add-points_size-range0.5.json --size_range 0.5 --rand_type range_gaussian
    --coco
    --size_range 0.5
    --val
    python huicv/coarse_utils/noise_data_utils.py generate_noisept_dataset data/coco/coco/annotations/instances_val2017.json data/coco/coco/annotations/instances_val2017_add-points_size-range0.5.json --size_range 0.5 --rand_type range_gaussian

    --Dvais
    python huicv/coarse_utils/noise_data_utils.py generate_noisept_dataset data/DAVIS/2017_val_first_frame_add_class_remove_57_48_34_33_31.json data/DAVIS/2017_val_first_frame_add_class_remove_57_48_34_33_31_add-points_size-range0.5.json --size_range 0.5 --rand_type range_gaussian
    
    --objects 365
    python utils/huicv/coarse_utils/noise_data_utils.py \
        generate_noisept_dataset \
        data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_train_subset_k1000.json \
        data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_train_subset_k1000_size-range0.5.json --size_range 0.5 --rand_type range_gaussian

    python utils/huicv/coarse_utils/noise_data_utils.py \
        generate_noisept_dataset \
        data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_train_subset_k500.json \
        data/Obj365_v2/annotations/zhiyuan_objv2_train_subset_k500_size-range0.5.json --size_range 0.5 --rand_type range_gaussian
    
    python utils/huicv/coarse_utils/noise_data_utils.py \
        generate_noisept_dataset \
        data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_train_subset_k20.json \
        data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_train_subset_k20_size-range0.5.json --size_range 0.5 --rand_type range_gaussian
    ...
    python utils/huicv/coarse_utils/noise_data_utils.py \
        generate_noisept_dataset \
        data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_train_subset_k500.json \
        data/Objects365/Obj365_v2/annotations/zhiyuan_objv2_train_subset_k500_size-range0.5.json --size_range 0.5 --rand_type range_gaussian
