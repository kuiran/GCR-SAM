...
from utils.huicv.json_dataset.coco_ann_utils import GCOCO
...
"""
--ytbvos
python utils/huicv/coarse_utils/noise_data_mask_utils.py generate_noisept_dataset \
    data/ytbvos18/val/2017_val_first_frame_add_class_total.json \
    dataytbvos18/val/2017_val_first_frame_add_class_total_add-points_size-range0.25_with-mask.json

--DVIAS
python huicv/coarse_utils/noise_data_mask_utils.py generate_noisept_dataset \
    data/DAVIS/2017_val_first_frame_add_class.json \
    data/DAVIS/2017_val_first_frame_add_class_add-points_size-range0.25_with-mask.json

python utils/huicv/coarse_utils/noise_data_mask_utils.py generate_noisept_dataset \
    data/DAVIS/2017_val_first_frame_add_class.json \
    data/DAVIS/2017_val_first_frame_add_class_add-points_size-range0.25_with-mask_1.json

--coco val
python huicv/coarse_utils/noise_data_mask_utils.py generate_noisept_dataset \
    data/coco/coco/annotations/instances_val2017.json \
    data/coco/coco/annotations/instances_val2017_size-range0.25_with-mask.json

--coco train
python huicv/coarse_utils/noise_data_mask_utils.py generate_noisept_dataset \
    data/coco/coco/annotations/instances_train2017.json \
    data/coco/coco/annotations/instances_train2017_size-range0.25_with-mask.json
"""
